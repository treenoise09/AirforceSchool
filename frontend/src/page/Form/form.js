...
const Form = () => {
  ...
  const [localImagePhotoType, setImagePhotoType] = useState(imagePhotoType);
  const [localImageIDCardType, setImageIDCardType] = useState(imageIDCardType);
  ...
  const handleNext = () => {
    ...
    if (activeStep == 1) {
      ...
      const isValidEmail = /\S+@\S+\.\S+/.test(addressCurrent.email);
      if (!isValidEmail) {
    ...
    if (activeStep == 2) {
      if(!validateForm3() || !(conditions.con1 && conditions.con2 && conditions.con3 && conditions.con4 && conditions.con5)){
        return alert("All informations need to be filled")
      }
    }
  ...
  const compileDataToJson = () => {
    const data = {
      ...
      imagePhotoType: imagePhotoType,
      imageIDCardType: imageIDCardType,
    };
  ...
  const handleImagePhotoUpload = (event) => {
    ...
    reader.onloadend = () => {
      ...
      setImagePhotoType("image/jpeg".includes(file.type) ? "jpeg" : "png");
    };
  ...
  const handleImageIDCardUpload = (event) => {
    ...
    reader.onloadend = () => {
      ...
      setImageIDCardType("image/jpeg".includes(file.type) ? "jpeg" : "png");
    };
  ...
  const validateForm2 = () => {
    if(
      !(addressRegistered.houseNo ||
      addressRegistered.villageNo ||
      addressRegistered.road ||
      addressRegistered.subDistrict ||
      addressRegistered.district ||
      addressRegistered.province ||
      addressRegistered.postalCode ||
      addressCurrent.houseNo ||
      addressCurrent.villageNo ||
      addressCurrent.road ||
      ...
      addressCurrent.email)
    ){
      setFormError("Please input all required fields in Address section.");
      return false;
    }
    setFormError("")
    return true
        ...
        return (
          <>
            ...
            <div className="p-4">
              <div
                className="mb-5"
                style={{ fontSize: "24px", color: "#F00", textAlign: "start" }}
              >
              ...
              <FormControl className="FormAlign">
                ...
                >
                  ...
                  <FormControlLabel
                    value="airforce"
                    control={<Radio />}
                    label="ทหารกองหนุน สังกัด กองทัพอากาศ"
                  />
                </RadioGroup>
                <div className="row d-flex">
                  <div className="col">
                    <FormLabel
                      id="demo-province-label"
                      style={{ fontSize: "14px" }}
                    >
                      วุฒิการศึกษา
                    </FormLabel>
                  ...
                  <div className="col">
                    <FormLabel
                      ...
                      style={{ fontSize: "14px" }}
                    >
                      ผลการศึกษาเฉลี่ยนสะสมตลอดหลักสูตร
                    </FormLabel>
                    <input
                      type="text"
                      value={gpa}
                      onChange={(e) => {
                        ...
                        if (e.target.value.length <= 4) {
                          handleNumericInputChange(e, setGpa);
                        }
                      }}
                ...
                <div className="row d-flex mb-5 align-items-start">
                  ...
                  <div className="col">
                    <FormLabel
                      id="demo-education-status-label"
                      style={{ fontSize: "14px" }}
                    >
                      สถานะการศึกษา
                    </FormLabel>
                ...
                <div className="row d-flex mb-3">
                  ...
                  <div className="col">
                    <FormLabel id="demo-dob-label" style={{ fontSize: "14px" }}>
                      เกิดวันที่
                    </FormLabel>
                    <div>
                      <input
                ...
                <div className="row d-flex mb-3">
                  ...
                  <div className="col">
                    <FormLabel
                      id="demo-father-firstname-label"
                      style={{ fontSize: "14px" }}
                    >
                      ชื่อ
                    </FormLabel>
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleNumericInputChange(e, setContactNumberFather);
                        }}
                  ...
                  <div className="col">
                    ...
                    <div>
                      <input
                        type="text"
                        value={motherPrefix}
                        onChange={(e) => setMotherPrefix(e.target.value)}
                        placeholder="คำนำหน้าชื่อมารดา"
                        className="ID-input"
                      />
                    </div>
                  </div>
                ...
                <div className="row d-flex mb-3">
                  ...
                  <div className="col">
                    ...
                    <div>
                      <input
                        type="text"
                        value={nationalityMother}
                        onChange={(e) => setNationalityMother(e.target.value)}
                        placeholder="สัญชาติ"
                        className="ID-input"
                      />
                    </div>
                  ...
                  <div className="col">
                    ...
                    <div>
                      <input
                        type="text"
                        value={contactNumberMother}
                        onChange={(e) => {
                          if (e.target.value.length > 10) {
                            return;
                          }
                          handleNumericInputChange(e, setContactNumberMother);
                        }}
                        placeholder="เบอร์โทรศัพท์ที่ติดต่อได้"
                        className="ID-input"
                      />
                ...
                <div className="row d-flex mb-3">
                  <div className="col">
                    ...
                    <div>
                      <input
                        type="text"
                        value={PrefixEmergency}
                        onChange={(e) => setPrefixEmergency(e.target.value)}
                  ...
                  <div className="col">
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) => setfirstnameEmergency(e.target.value)}
                        placeholder="ชื่อ"
                        className="ID-input"
                      />
                    </div>
                  ...
                  <div className="col">
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) => setlastnameEmergency(e.target.value)}
                        placeholder="นามสกุล"
                        className="ID-input"
                      />
                    </div>
                    ...
                    <div>
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          handleNumericInputChange(e, setContactPhone);
                        }}
                        placeholder="เบอร์โทรศัพท์ที่ติดต่อได้"
                        className="ID-input"
                      />
                ...
                <div className="text-center m-5" style={{ fontSize: "24px" }}>
                  การขอรับสิทธิคะแนนเพิ่มพิเศษ
                </div>
                  ...
                  <FormControlLabel
                    control={
                      <Checkbox
                        ...
                        onChange={(e) =>
                          setMilitaryCourseCompleted(e.target.checked)
                        }
                      />
                    }
                    label=""
        ...
        return (
          <>
            <Box className="p-5">
              ...
              <div className="row d-flex mb-3">
                <div className="col">
                  ...
                  <div>
                    <input
                      ...
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressRegistered.villageNo}
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressRegistered.subDistrict}
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
              ...
              <div className="row d-flex mb-3">
                ( โปรดระบุที่อยู่ของท่านโดยละเอียด เช่น บ้านเลขที่ หมู่บ้าน
                อาคาร ชั้น ซอย และถนน )
              </div>
              <div className="row d-flex mb-3">
                <div className="col">
                  <FormLabel
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressRegistered.district}
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressRegistered.province}
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressRegistered.postalCode}
                      onChange={(e) =>
                        setAddressRegistered((prevState) => ({
                          ...prevState,
              ...
              <div className="row d-flex mb-3">
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressCurrent.houseNo}
                      onChange={(e) =>
                        setAddressCurrent((prevState) => ({
                          ...prevState,
                          houseNo: e.target.value,
                        }))
                      }
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressCurrent.villageNo}
                      onChange={(e) =>
                        setAddressCurrent((prevState) => ({
                          ...prevState,
                          villageNo: e.target.value,
                ...
                <div className="col">
                  ...
                  <div>
                    <input
                      type="text"
                      value={addressCurrent.subDistrict}
                      onChange={(e) =>
                        setAddressCurrent((prevState) => ({
                          ...prevState,
                          subDistrict: e.target.value,
        ...
        return (
          <>
            <Box className="p-5">
              ...
              <div className="row d-flex mb-3">
                ส่วนที่ 1 รูปแบบข้อมูลและการใช้งานหน้าเว็บเพ็จ
              </div>
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="data-complete-label"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  ข้อมูลในระเบียบการรับสมัครครบถ้วน อธิบายชัดเจน
                  เป็นประโยชน์ต่อการสมัคร
                </FormLabel>
              </div>
              ...
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="webpageFormat-lable"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  รูปแบบเว็บเพจมีความทันสมัย รูปภาพและสี มีความเหมาะสม น่าสนใจ
                </FormLabel>
              </div>
              <div className="scorebody FormAlign pt-2 ps-2">
                <RadioGroup
              ...
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="readableText-lable"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  อักษร อ่านง่าย ชัดเจน
                </FormLabel>
              </div>
              <div className="scorebody FormAlign pt-2 ps-2">
                <RadioGroup
              ...
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="newsChannels-lable"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  ช่องทางการรับทราบข่าวสารในการรับสมัคร ( สามารถต้อบได้มากกว่า 1
                  ข้อ )
                </FormLabel>
              </div>
              <div className="scorebody FormAlign pt-2 ps-2">
                ...
                >
                  ...
                  <FormControlLabel
                    value="internetMedia"
                    control={<Radio />}
                    label="สื่ออินเตอร์เน็ต"
                  />
                  <FormControlLabel
                    value="radioTV"
                    control={<Radio />}
                    label="วิทยุ/โทรทัศน์"
                  />
                  <FormControlLabel
                    value="magazinePrint"
                    control={<Radio />}
                    label="วารสาร/สื่อพิมพ์"
                  />
                  <FormControlLabel
                    value="billboard"
                    control={<Radio />}
                    label="ป้ายประชาสัมพันธ์"
                  />
                  <FormControlLabel
                    value="airForceUnit"
                    control={<Radio />}
                    label="หน่วยงานกองทัพอากาศ"
                  />
                </RadioGroup>
              </div>
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="reasonForApplying-lable"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  มูลเหตุจูงใจที่ทำให้ท่านมาสมัครเข้าเป็นนักเรียนจ่าอากาศ (
              ...
              <div className="scorebody FormAlign pt-2 ps-2">
                ...
                >
                  <FormControlLabel
                    value="serveNation"
                    control={<Radio />}
                    label="ได้มีโอกาสรับใช้ชาติ"
                  />
                  <FormControlLabel
                    value="becomeAirforce"
                    control={<Radio />}
                    label="ต้องการเป็นทหารอากาศ"
                  />
                  <FormControlLabel
                    value="stableProfession"
                    control={<Radio />}
                    label="เป็นอาชีพที่มั่นคงและมีสวัสดีการ"
                  />
                  <FormControlLabel
                    value="familyRecommendation"
                    control={<Radio />}
                    label="บิดา มารดา ญาติพี่น้องแนะนำ"
                  />
                  <FormControlLabel
                    value="noTuitionFee"
                    control={<Radio />}
                    label="ไม่เสียค่าใช้จ่ายระหว่างการศึกษา"
                  />
                  <FormControlLabel
                    value="careerProgression"
                    control={<Radio />}
                    label="มีความก้าวหน้าในอาชีพและให้ทุนการศึกษาต่อในระดับที่สูงขึ้น"
                  />
                </RadioGroup>
              </div>
              <div className="scoreheader FormAlign ps-2">
                <FormLabel
                  id="promoInterest-lable"
                  className="mt-2 mb-2"
                  style={{ fontWeight: "700" }}
                >
                  ข้อมูลในการประชาสัมพันธ์น่าสนใจและเป็นประโยชน์
                </FormLabel>
              </div>
              <div className="scorebody FormAlign pt-2 ps-2">
                <RadioGroup
              ...
              <div style={{ textAlign: "start" }}>
                <FormControlLabel
                  ...
                  control={<Checkbox onChange={(e) => {
                    const newCon = !conditions.con1
                    setConditions({...conditions,con1:newCon})}} />}
                ...
                <FormControlLabel
                  value="end"
                  control={<Checkbox onChange={(e) => {
                    const newCon = !conditions.con2
                    setConditions({...conditions,con2:newCon})}}/>}
                ...
                <FormControlLabel
                  value="end"
                  control={<Checkbox onChange={(e) => {
                    const newCon = !conditions.con3
                    setConditions({...conditions,con3:newCon})}} />}
                ...
                <FormControlLabel
                  value="end"
                  control={<Checkbox onChange={(e) => {
                    const newCon = !conditions.con4
                    setConditions({...conditions,con4:newCon})}} />}
                ...
                <FormControlLabel
                  value="end"
                  control={<Checkbox onChange={(e) => {
                    const newCon = !conditions.con5
                    setConditions({...conditions,con5:newCon})}} />}
              ...
              <div className="center mt-5">
                <Typography
                  ...
                  style={{ fontSize: "20px" }}
                >
                  ( กรุณาตรวจสอบข้อมูลที่กรอกในใบสมัครไห้ถูกต้องและครบถ้วน
                  ก่อนกดปุ่ม “ยืนยันข้อมูล”
                  ซึ่งหลังจากกดปุ่มจะไม่สามารถแก้ไขข้อมูลได้อีกแล้ว )
                </Typography>
              </div>
            </Box>
          </>
          ...
          <>
            <Box className="p-5">
              <div
                ...
                style={{ backgroundColor: "#000a23", color: "#fff" }}
              >
                <Typography variant="h4" className="header-text">
                  ข้อมูลผู้สมัคร
                </Typography>
              ...
              <div
                ...
                style={{ boxShadow: "2px 2px 5px black", height: "auto" }}
              >
                <div className="row" style={{ width: "100vh" }}>
                  <div className="col-4 d-flex flex-column align-items-center">
                    ...
                    {localImagePhoto && (
                      <img
                        src={localImagePhoto}
                        alt="Uploaded Photo"
                        className="uploaded-image align-items-center"
                        style={{ width: "20vh" }}
                      />
                    )}
                    <Typography>สถานะรูปถ่าย :</Typography>
                    <Typography>เหตุผล:</Typography>
                    <Typography>วันที่อัพโหลดรูปถ่ายครั้งล่าสุด:</Typography>
                    <input
                      type="file"
                      style={{ display: "none" }}
                  ...
                  <div className="col-4 d-flex flex-column align-items-center">
                    <Typography>รูปถ่ายบัตรประชาชน</Typography>
                    {localImageIDCard && (
                      <img
                        src={localImageIDCard}
      ...
      <div style={{ padding: 25 }}>
        ...
        <div className="footer-buttons">
          ...
          <Button
            ...
            onClick={
              activeStep === steps.length - 1 ? handleSaveData : handleNext
            }
          >
