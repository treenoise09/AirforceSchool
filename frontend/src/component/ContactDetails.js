...
const ContactDetails = () => {
    return (
        <>
        <div className='row'  style={{height:"100vh",backgroundColor:"#002855",padding:'15px'}}>
        <div className='col-6'>
            <LoadScript
                googleMapsApiKey="AIzaSyDgFMdvdOfKGGMTCq_-cn__DigQQxufomc"
            >
                <GoogleMap
...
<p>
โรงเรียนจ่าอากาศ
171/1 หมู่ 10 ถนนพหลโยธิน แขวงสนามบิน เขต ดอนเมือง
กรุงเทพมหานคร 10210
</p>
                <p>Phone</p>
                <p> 0-2534-5266</p>
                <p>Email</p><p>recruitmentatts@gmail.com</p>
                <p>Social</p>
                <p>CALL CENTER
02 534 5266</p>
<p><a href="https://www.facebook.com/ATTS.educate/?locale=th_TH" target="_blank" rel="noopener noreferrer">
